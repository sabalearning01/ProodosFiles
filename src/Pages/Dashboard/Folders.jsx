  ...
  return (
    <div>
      <div className="hidden lg:flex justify-between items-center ">
        <div>
          <input
            className="text-xs  w-261px h-[40px] border border-[#EAEAEA] mt-[26px] ml-[295px] p-4 rounded-3xl font-[Poppins] font-normal"
            type="text"
            placeholder="Search"
          ></input>
        </div>
      ...
      <div className="flex justify-between items-center mt-[28px] ml-[44px] md:ml-[300px] lg:ml-[300px] mr-[44px]">
        <h3 className="text-[#242424] font-[Poppins] text-sm font-normal opacity-50">
          All Folders
        </h3>
        <div className="flex justify-center items-center gap-1  ">
          <img src={filter} alt="" />
          <h3 className="font-[Poppins] text-[#242424] font-normal text-sm opacity-50  md:mr-[65px]">
            Filter
          </h3>
        </div>
      </div>
