     ...
     {isMenuOpen ? (
      ...
      <div className='w-[90%] ml-[20px] mt-[20px] h-[692px] lg:w-[70%] lg:h-[506px] border border-[#EAEAEA] rounded-xl lg:ml-[350px] lg:mt-[40px]'>
          ...
          <div className='lg:flex justify-between items-center mt-[24px] ml-[24px] mr-[24px]'>
            <div><h3 className='font-[Poppins] font-normal text-base text-[#242424] '>Personal Info</h3> <h4 className='font-[Poppins] text-sm text-[#475467]  '>Update your photo and personal details here.</h4></div>
            <button className='bg-[#773DD3] text-[#ffff] pt-[10px] pb-[10px] pl-[24px] pr-[24px] rounded-lg'>Save</button>
            </div>
         ...
         <div className='flex justify-between items-center lg:ml-[24px] lg:mr-[24px] lg:mt-[24px]'>
          ...
          <input className='lg:w-[512px] lg:h-[44px] border border-[#EAEAEA] pl-[10px] text-[#242424] ' type="text" placeholder='Jack Baeur'/>
         </div>
         ...
         <div className='flex justify-between items-center lg:ml-[24px] lg:mr-[24px] lg:mt-[24px]'>
          ...
          <input className='lg:w-[512px] lg:h-[44px] border border-[#EAEAEA] pl-[10px] text-[#242424] ' type="text" placeholder='JackBaeur@gmail.com'/>
         </div>

         <hr className='mt-[24px] w-[95%] ml-[20px]'/>

         <div className='lg:flex justify-between items-center mt-[24px] ml-[24px] mr-[24px]'>
            <div><h3 className='font-[Poppins] font-normal text-base text-[#242424] '>Your photo</h3> <h4 className='font-[Poppins] text-sm text-[#475467]  '>This will be displayed on your profile.</h4></div>
          
          <div className='flex justify-between gap-[35px]'> 
            <div className='rounded-full  h-[50px] pt-3 pb-3 pl-4 pr-4 bg-[#F2F4F7] '>JB</div>
             <div className='w-[428px] border border-[#EAEAEA] pt-[10px] '>
              <img  className="mx-auto" src={uploadcloud}/>
              <h3 className='text-center text-sm font-[Poppins] text-[#242424] font-medium'> Click to upload <span className='text-xs font-normal text-[#475467]'>or drag and drop <br/> SVG, PNG,JPG or GIF (max,800x400px)</span> </h3>
             </div>
